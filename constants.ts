...
export const MOCK_CODEX_ENTRIES: CodexEntry[] = [
  // === REGIONS (4) ===
  {
    ...
    title: "The Highlands",
    category: "Regions",
    text: "Rolling green hills and windswept prairie dominate the heart of Summerland Island. Sheep farmers work the land around the Needleback mountain, while the ancient Waystone draws travelers from across the island. The Highlands serve as the crossroads connecting all four regions.",
    status: "canon",
    tags: ["region", "central", "safe"],
  },
  {
    id: "region_stormwall",
    title: "Stormwall Coast",
    category: "Regions",
    text: "A harsh coastline battered by endless storms. Glacio-karst cliffs drop into churning grey seas. The flotsam hunters of this region make their living salvaging shipwrecks, while the ruins of the Black Fort loom over the coast—a reminder of darker times.",
    status: "canon",
    tags: ["region", "coastal", "dangerous"],
  },
  {
    id: "region_caledonia",
    title: "Caledonia",
    category: "Regions",
    text: "The prosperous western coast, dominated by Caledonia City and its bustling harbor. Mediterranean warmth meets political intrigue here. The Baroness and the City Chief vie for influence, while scholars brave the Howling-Spine to study ancient ruins at Forel.",
    status: "canon",
    tags: ["region", "urban", "political"],
  },
  {
    id: "region_dunamar",
    title: "Dunamar",
    category: "Regions",
    text: "The arid southeast, where golden dunes meet sun-baked hills. Water is precious here. The small fishing settlement of Caleta de Pedro clings to the coast, while hunters track game through the harsh interior. Deep in the hills lies La Cueva de Aris—a cave system said to hold ancient secrets.",
    status: "canon",
    tags: ["region", "desert", "mysterious"],
  },
  ...
  // === KEY LOCATIONS (10) ===
  {
    ...
    title: "The Waystone",
    category: "Locations",
    text: "An ancient monolith of weathered stone rising from the highland prairie. Faded runes spiral up its surface, and the air around it shimmers faintly. Travelers say those who rest here dream of distant places. Some claim the Waystone was built by the same hands that raised the Black Fort—though no one remembers who that was.",
    status: "canon",
    tags: ["landmark", "ancient", "safe"],
  },
  {
    id: "loc_black_fort",
    title: "Black Fort Ruins",
    category: "Locations",
    text: "Crumbling dark stone walls on a coastal cliff, overgrown with moss and haunted by ravens. Once a mighty fortification, now only legends remain of who built it and why it fell. The flotsam hunters avoid the inner chambers, speaking of strange sounds on stormy nights. Ronan of Brecan Hills tells tales passed down from his grandparents—but even he admits the truth has been lost to time.",
    status: "canon",
    tags: ["ruins", "mysterious", "dangerous"],
  },
  {
    id: "loc_flotsam_hold",
    title: "The Flotsam Hold",
    category: "Locations",
    text: "A sturdy tavern built from salvaged ship timbers and driftwood, serving as the heart of the flotsam hunter community. Morag runs a tight establishment—newcomers are watched carefully until they prove themselves. The walls are decorated with salvage trophies: a ship's wheel, brass fittings, a figurehead with salt-worn features.",
    status: "canon",
    tags: ["tavern", "community", "stormwall"],
  },
  {
    id: "loc_caledonia_city",
    title: "Caledonia City",
    category: "Locations",
    text: "The largest settlement on Summerland Island, a bustling port where merchant ships crowd the harbor. Stone buildings line market squares with colorful awnings. Power here is split between City Chief Elodie Perrin and Baroness Solene de Vallois—an arrangement that keeps both in check, and everyone else guessing.",
    status: "canon",
    tags: ["city", "trade", "political"],
  },
  {
    id: "loc_forel",
    title: "Forel",
    category: "Locations",
    text: "A small scholar camp at the end of the Howling-Spine isthmus, where academics study ancient stone ruins. Camille Durand leads the expedition with demanding precision. The isolation is intentional—fewer interruptions, fewer thieves. What they have found remains closely guarded.",
    status: "canon",
    tags: ["ruins", "scholars", "isolated"],
  },
  {
    id: "loc_cueva_aris",
    title: "La Cueva de Aris",
    category: "Locations",
    text: "A deep cave system carved into the hills of Dunamar. The entrance is unremarkable, but those who venture deep enough speak of strange carvings and a faint glow from within. Aris, the hermit who dwells there, claims to understand what the stones remember. Most dismiss him as mad. Some are not so sure.",
    status: "canon",
    tags: ["cave", "mysterious", "aris"],
  },
  {
    id: "loc_howling_spine",
    title: "The Howling-Spine",
    category: "Locations",
    text: "A narrow rocky isthmus connecting the Caledonia mainland to the Forel spur. The wind never stops here—it howls through the rocks, bending grass flat and stealing words from mouths. Crossing in a storm is suicide. Even on calm days, the path demands respect.",
    status: "canon",
    tags: ["dangerous", "path", "wind"],
  },
  {
    id: "loc_brecan_hills",
    title: "Brecan Hills",
    category: "Locations",
    text: "Isolated windswept hills overlooking the Stormwall Coast. Only Ronan lives here now, a former fighter who keeps the old stories alive. His cottage is small but well-maintained, and his hospitality is genuine—if you can find him.",
    status: "canon",
    tags: ["isolated", "ronan", "stories"],
  },
  {
    id: "loc_needleback",
    title: "The Needleback",
    category: "Locations",
    text: "A rugged mountain rising from the highland prairie, its jagged peak resembling a needle against the sky. Sheep farms dot the lower slopes, tended by families who have worked this land for generations. Dave knows every trail and every flock—and he watches the mountain paths more carefully than most realize.",
    status: "canon",
    tags: ["mountain", "farming", "highlands"],
  },
  {
    id: "loc_caleta_pedro",
    title: "Caleta de Pedro",
    category: "Locations",
    text: "A small coastal settlement around a sheltered cove in Dunamar. Whitewashed buildings with terracotta roofs cluster near the water, where fishing boats rest in calm turquoise shallows. Pedro keeps the peace here with practical promises and a warm smile. Life is simple—water is precious, and everyone helps.",
    status: "canon",
    tags: ["settlement", "fishing", "dunamar"],
  },

  // === FACTIONS (5) ===
  {
    id: "faction_flotsam",
    title: "The Flotsam Hunters",
    category: "Factions",
    text: "Salvagers who work the Stormwall Coast, claiming what the sea gives up. Domhnall leads them with quiet authority earned over decades. They have a code: share the haul fairly, never steal from the living, and respect the sea that feeds them. Outsiders must prove themselves before they are trusted with salvage routes.",
    status: "canon",
    tags: ["faction", "stormwall", "salvage"],
  },
  {
    id: "faction_caledonia_guard",
    title: "Caledonia City Guard",
    category: "Factions",
    text: "The official peacekeepers of Caledonia City, led by Captain Luc Renard. Procedure-first and clockwork-precise, the Guard maintains order in the markets and docks. Brigitte Lenoir trains the recruits with blunt efficiency. They answer to the City Chief, though the Baroness has been known to... request favors.",
    status: "canon",
    tags: ["faction", "caledonia", "law"],
  },
  {
    id: "faction_forel_scholars",
    title: "Scholars of Forel",
    category: "Factions",
    text: "A small academic expedition studying the ancient ruins at Forel. Camille Durand leads with demanding standards—every artifact catalogued, every theory tested. Remi Lefevre handles the details with anxious precision. They seek answers about who built the ruins and why. So far, they have found only more questions.",
    status: "canon",
    tags: ["faction", "scholars", "ruins"],
  },
  {
    id: "faction_dunamar_hunters",
    title: "Dunamar Hunters",
    category: "Factions",
    text: "Celia and Nerea lead the hunters who track game through the arid hills of Dunamar. They know every water source, every animal trail, every safe shelter. Outsiders who waste water or disrespect the land are not welcome. Those who prove themselves may learn the desert's secrets.",
    status: "canon",
    tags: ["faction", "dunamar", "hunters"],
  },
  {
    id: "faction_baroness_circle",
    title: "The Baroness's Circle",
    category: "Factions",
    text: "Baroness Solene de Vallois holds no official title, yet her influence in Caledonia is undeniable. She owns land, trades favors, and remembers every debt. Her circle includes merchants, minor nobles, and anyone useful. Dealings with the Baroness are always polite, always transactional, and never forgotten.",
    status: "canon",
    tags: ["faction", "caledonia", "political"],
  },

  // === HISTORY & LEGENDS (6) ===
  {
    id: "history_black_fort_fall",
    title: "The Fall of the Black Fort",
    category: "History",
    text: "No one remembers who built the Black Fort or why it fell. The stones are old—older than any family on the island can trace. Ronan tells stories his grandparents told him: of a siege that lasted a year, of defenders who vanished in a single night, of something sealed in the deepest chamber. But stories change with each telling.",
    status: "rumor",
    tags: ["history", "black fort", "mystery"],
  },
  {
    id: "history_waystone_origin",
    title: "The Waystone Builders",
    category: "History",
    text: "The Waystone predates every settlement on Summerland Island. Its runes match no known language, though scholars at Forel believe they share patterns with carvings found in La Cueva de Aris. Some say the Waystone was a marker—a boundary or a warning. Others say it was a door. Aris claims both are true.",
    status: "rumor",
    tags: ["history", "waystone", "ancient"],
  },
  {
    id: "history_island_name",
    title: "Why Summerland?",
    category: "History",
    text: "The island's name is a mystery. The Highlands are temperate, Stormwall is battered by gales, and Dunamar bakes under harsh sun. Only Caledonia enjoys true summer warmth. Some say the name is ironic. Others claim it refers to something older—a promise, or a memory of what the island once was.",
    status: "rumor",
    tags: ["history", "island", "name"],
  },
  {
    id: "legend_aris_knowledge",
    title: "What Aris Knows",
    category: "Legends",
    text: "The hermit of La Cueva claims the stones remember. He speaks of patterns in the rock, of messages left by those who came before. Most dismiss him as a madman talking to caves. But Camille Durand has visited him twice, and she does not waste time on fools.",
    status: "rumor",
    tags: ["legend", "aris", "mystery"],
  },
  {
    id: "legend_sea_gives",
    title: "The Sea Gives, The Sea Takes",
    category: "Legends",
    text: "A flotsam hunter saying. The Stormwall Coast is littered with wrecks—ships that misjudged the rocks, or were driven onto them by storms. The hunters salvage what they can, but they never take from a wreck until the sea has claimed it fully. To do otherwise invites the sea's attention.",
    status: "canon",
    tags: ["legend", "stormwall", "tradition"],
  },
  {
    id: "legend_deep_stone",
    title: "The Deep Stone",
    category: "Legends",
    text: "Aris speaks of something beneath La Cueva—not treasure, but knowledge. He calls it the Deep Stone, a place where the cave walls are covered in carvings older than the Waystone itself. He has never shown it to anyone. He says it is not ready to be found. Or perhaps, we are not ready to find it.",
    status: "rumor",
    tags: ["legend", "aris", "cueva", "mystery"],
  },
];
