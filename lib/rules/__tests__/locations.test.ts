...
vi.mock("../cache", () => ({
  getLocationConnectionRules: vi.fn().mockResolvedValue([
    ...
    { id: "3", fromLocation: "The Waystone", toLocation: "Windhollow Wilderness", requirements: null, travelTime: 1 },
    { id: "4", fromLocation: "Windhollow Wilderness", toLocation: "The Waystone", requirements: null, travelTime: 1 },
...
describe("Locations Rules", () => {
  ...
  describe("getValidDestinations", () => {
    it("returns all valid destinations from The Waystone", async () => {
      ...
      expect(destinations).toContain("Windhollow Wilderness");
  ...
  describe("getLocationConstraints", () => {
    it("returns valid options as constraints", async () => {
      ...
      expect(constraints.validOptions).toContain("Windhollow Wilderness");
    });
  });
});
